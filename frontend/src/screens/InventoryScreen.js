...
export default function InventoryScreen() {
  ...
  const updateFSInventory = async (productId, event) => {
    console.log('updateFSInventory');
    const countInStock = parseFloat(event.target.value);
                  ...
                  <div className="row">
                    ...
                    <div className="col-2 mb-3">
                      <input
                        ...
                        value={product.price}
                        onBlur={(event) => {
                          updateFSInventory(product.id, event);
                        }}
                        onChange={(event) => {
